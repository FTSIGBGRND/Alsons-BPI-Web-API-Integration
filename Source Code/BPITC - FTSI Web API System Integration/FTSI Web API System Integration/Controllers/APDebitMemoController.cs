...
{
    [Route("api/documents/apdebitmemo")]
    [ApiController]
    [Authorize]
    public class APDebitMemoController : ControllerBase
    {
        private readonly APCreditMemoService _service;

        public APDebitMemoController(APCreditMemoService service)
        {
            _service = service;
        }
        ...
        public async Task<ActionResult<GetResponse>> GetStatus(Guid id)
        {
            ...
            APCreditMemoHeader header = new APCreditMemoHeader();
